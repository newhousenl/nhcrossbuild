  ...
  outputs =
    { self, nixpkgs }:
    {
      devShells =
        let
          makeDevShell =
            ...
            pkgs.stdenvNoCC.mkDerivation {
              ...
              toolchainfile_macos_single = pkgs.writeText "mactoolchain_single.cmake" toolchain_macos.toolchaintxt_single;
              toolchainfile_macos_dual = pkgs.writeText "mactoolchain_dual.cmake" toolchain_macos.toolchaintxt_dual;
              toolchainfile_linux = pkgs.writeText "linuxtoolchain.cmake" toolchain_linux.toolchaintxt;
              toolchainfile_windows_mingw_x86_64 = pkgs.writeText "windows_mingw_x86_64toolchain.cmake" toolchains_windows_mingw.x86_64.toolchaintxt;
              toolchainfile_windows_mingw_aarch64 = pkgs.writeText "windows_mingw_aarch64toolchain.cmake" toolchains_windows_mingw.aarch64.toolchaintxt;
              shellHook = ''
        ...
        in
        {
          x86_64-linux.default = makeDevShell {
            system = "x86_64-linux";
            inherit nixpkgs;
          };
          aarch64-linux.default = makeDevShell {
            system = "aarch64-linux";
            inherit nixpkgs;
          };
          x86_64-darwin.default = makeDevShell {
            system = "x86_64-darwin";
            inherit nixpkgs;
          };
          aarch64-darwin.default = makeDevShell {
